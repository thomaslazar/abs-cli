...
/// no combining-class blocking (.NET exposes no ccc data), so uncomposable
/// marks never block later ones; see UnicodeNfcTests for the pinned
/// divergences. Lone surrogates become U+FFFD (EnumerateRunes). Tables live
/// in UnicodeNfc.g.cs, generated by tools/GenerateNfcTables.
/// </summary>
