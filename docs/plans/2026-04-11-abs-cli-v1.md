...
## Task 6: Token Helper (JWT Expiry Check)
...
## Task 16: Docker Integration Test Setup
...
- [ ] **Step 3: Make seed script executable and test**
...
```bash
git add docker/
git commit -m "feat: add Docker Compose and seed script for integration testing"
```
...
| 2 | Test project | 1 |
| 3 | Configuration layer | 1 |
| 4 | Console output helper | 1 |
| 5 | Filter encoder | 1 |
| 6 | Token helper | 1 |
| 7 | Core DTOs | 1 |
| 8 | API client | 1 |
| 9 | Login command | 1 |
| 10 | Config command | 1 |
| 11 | Libraries commands | 1 |
| 12 | Items commands | 1 |
| 13 | Series commands | 1 |
| 14 | Authors commands | 1 |
| 15 | Search command | 1 |
| 16 | Docker test setup | 1 |
